<template>
  <div class="mx-4 my-24 p-12 bg-gray-800/50 rounded-xl border border-gray-700">
    <div class="text-center">
      ...
      <NuxtLink to="contact"><button class="px-8 py-4 bg-[#E1FF2D] text-black text-lg font-bold rounded hover:bg-[#d4f909] transform hover:-translate-y-1 transition-all">
        Get in Touch
      </button>
      </NuxtLink>
    </div>
